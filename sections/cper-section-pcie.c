...
json_object *cper_section_pcie_to_ir(const UINT8 *section, UINT32 size)
{
	...
	if (isvalid_prop_to_ir(&ui64Type, 6)) {
		...
		JSON_FIELD_INT(register_fields_ir, rsvdp,
			       cap_decode->root_status);
		json_object_object_add(pcie_capability_ir, "root_status",
				       register_fields_ir);
		...
		JSON_FIELD_INT(register_fields_ir,
			       ...
			       cap_decode->link_control2);
		json_object_object_add(pcie_capability_ir, "link_control2",
				       register_fields_ir);
		...
		JSON_FIELD_BOOL(register_fields_ir, drs_message_received,
				cap_decode->link_status2);
		json_object_object_add(pcie_capability_ir, "link_status2",
				       register_fields_ir);
		...
		json_object_object_add(pcie_capability_ir, "slot_control2",
				       register_fields_ir);
		...
		json_object_object_add(pcie_capability_ir, "slot_status2",
				       register_fields_ir);
	...
	if (isvalid_prop_to_ir(&ui64Type, 7)) {
		...
		register_fields_ir = json_object_new_object();
		JSON_FIELD_INT(
			register_fields_ir, first_error_pointer,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir, ecrc_generation_capable,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir, ecrc_generation_enable,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir, ecrc_check_capable,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir, ecrc_check_enable,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir, multiple_header_recording_capable,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir, multiple_header_recording_enable,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir, tlp_prefix_log_present,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir,
			...
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_INT(
			register_fields_ir, header_log_size,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_BOOL(
			register_fields_ir, logged_tlp_was_flit_mode,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_INT(
			register_fields_ir, logged_tlp_size,
			aer_decode->advanced_error_capabilities_and_control);
		JSON_FIELD_INT(
			register_fields_ir, rsvdp,
			aer_decode->advanced_error_capabilities_and_control);
		json_object_object_add(
			aer_capability_ir,
			"advanced_error_capabilities_and_control",
